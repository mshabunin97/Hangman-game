...
const stopGame = (status) => {
    ...
    <div class="social-icons">
      <a href="https://github.com/mshabunin97" target="_blank"  class="social-icon"><i class="fab fa-github"></i></a>
      <a href="https://t.me/Kurugurugi" target="_blank" class="social-icon"><i class="fab fa-telegram" aria-hidden="true"></i></a>
      <a href="#" class="social-icon" target="_blank" ><i class="fa fa-suitcase" aria-hidden="true"></i></a>
    </div>
  `;
  ...
  document.getElementById("game").insertAdjacentHTML("beforeend", socialIconsHTML);
...
export const startGame = () => {
  ...
  gameDiv.insertAdjacentHTML(
    "beforeend",
    '<button id="quit" class="button-secondary px-2 py-1 mt-4">Qiut</button>'
  );
